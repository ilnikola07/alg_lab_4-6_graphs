...
namespace lab_4_6_graph
{
    public partial class Lab4Control : UserControl
    {
        ...
        private void buttonBFS_Click(object sender, EventArgs e)
        {
            ...
            txtOutput.Text = "Порядок BFS: " + string.Join(" -> ", result);
        }
            ...
            using (OpenFileDialog ofd = new OpenFileDialog())
            {
                ...
                if (ofd.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        ...
                        cmbEnd.Items.Clear();
                        txtLog.Clear(); // Это ваш TextBox (Multiline) для вывода логов
                        ...
                        lblResult.Text += $"Вершин (пещер): {allCaves.Length}\n";
                        lblResult.Text += $"Рёбер (тоннелей): {edgeCount}\n";
